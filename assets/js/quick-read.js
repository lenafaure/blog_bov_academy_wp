...
window.onload= function() {
    ...
    function expandArticle(index) {
      ...
      setTimeout(function() {scrollBottomPos = scrollTopPos + content[index].getBoundingClientRect().height - window.innerHeight + 300}, 700);
      setTimeout(function() {timer = true}, 700);
