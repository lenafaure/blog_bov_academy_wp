...
function twentyseventeen_scripts() {
	...
	wp_enqueue_style('roboto', 'https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700|Roboto+Slab:300,400');
    wp_enqueue_style('material-icons', 'https://fonts.googleapis.com/icon?family=Material+Icons');
    wp_enqueue_style('icomoon', get_template_directory_uri().'/assets/icomoon/style.css');
    	// Theme stylesheet.
   ...
   /*wp_enqueue_script( 'twentyseventeen-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '1.0', true );*/	
	...
	wp_enqueue_script( 'tweenmax','https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.0/TweenMax.min.js', array(), null, true);
	wp_enqueue_script( 'gsap-scrollto','https://cdnjs.cloudflare.com/ajax/libs/gsap/1.19.0/plugins/ScrollToPlugin.min.js', array(), null, true);
	wp_enqueue_script( 'quick-read', get_theme_file_uri( '/assets/js/quick-read.js' ), array(), null, true);
	wp_enqueue_script( 'subscribe-button', get_theme_file_uri( '/assets/js/subscribe-button.js' ), array(), null, true);
